...
class User(db.Model, UserMixin):
    ...
    password_hash = db.Column(db.String(60), nullable=False) # Feature 6: Password Hashing
    
    # Feature 8 & 24: Budget and Currency Preferences
    daily_budget = db.Column(db.Float, default=50.0) 
